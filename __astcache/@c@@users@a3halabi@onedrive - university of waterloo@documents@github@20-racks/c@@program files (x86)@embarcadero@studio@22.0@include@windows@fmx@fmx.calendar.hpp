...
// (DO NOT EDIT: machine generated header) 'FMX.Calendar.pas' rev: 35.00 (Windows)
...
public:
	...
	static const bool DefaultTodayDefault = false;
	
	static const bool DefaultWeekNumbers = false;
...
//-- var, const, procedure ---------------------------------------------------
static const System::Word MM_DATE_CHANGED = System::Word(0x1701);
static const System::Word MM_WEEKNUMBERS_CHANGED = System::Word(0x1702);
static const System::Word MM_FIRSTDAYOFWEEK_CHANGED = System::Word(0x1703);
static const System::Word MM_CALENDAR_USER = System::Word(0x1704);
}	/* namespace Calendar */
}	/* namespace Fmx */
